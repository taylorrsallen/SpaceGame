...
public class VideoIntro : MonoBehaviour, IIntroPlayer {
    ...
    public VideoPlayer intro_audio_only_video;
    ...
    private void play_audio() {
        ...
        if (intro_audio_only_video) intro_audio_only_video.Play();
    }
    ...
    public void play() {
        ...
        render_material.color = Color.black;
        render_material.SetColor("_EmissionColor", Color.black);
